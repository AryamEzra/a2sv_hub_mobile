...
const Color pageBackgroundColor = Color(0xFFF5F5F5); // Assuming Colors.grey[100] -> Use same as Scaffold bg
const Color cardBorderColor = Color(0xFFDCDCDC); // Slightly darker grey for border (e.g., grey[300])
...
class ProgressCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final double progressPercent = (solvedProblems / totalProblems).clamp(0.0, 1.0);
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 8.0),
             _buildStatusRow(
              context: context,
              color: lightGrey, // Use light grey for available indicator dot background
              label: "Available",
  ...
  Widget _buildTopRow(BuildContext context) {
    ...
    const BoxConstraints iconButtonConstraints = BoxConstraints(minWidth: 30, minHeight: 30);
    ...
    return Row(
      children: <Widget>[
        ...
        IconButton(
          ...
          iconSize: iconButtonSize, color: darkGrey,
          constraints: iconButtonConstraints, padding: EdgeInsets.zero,
          onPressed: () { print("Up arrow pressed"); },
        ...
        IconButton(
          ...
          iconSize: iconButtonSize, color: darkGrey,
          constraints: iconButtonConstraints, padding: EdgeInsets.zero,
          onPressed: () { print("Down arrow pressed"); },
        ...
        children: <Widget>[
          SizedBox( // Background
            ...
            child: CircularProgressIndicator(
              value: 1.0, strokeWidth: strokeWidth,
              backgroundColor: lightGrey, valueColor: AlwaysStoppedAnimation<Color>(lightGrey),
            ),
          ),
          SizedBox( // Foreground
            width: circleSize, height: circleSize,
            child: CircularProgressIndicator(
              value: progressPercent, strokeWidth: strokeWidth,
          ...
          Column( // Text
            ...
            children: <Widget>[
              Text("Problems", style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Colors.grey[600])),
              const SizedBox(height: 4),
              Text("$totalProblems", style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.bold)),
            ],
          ),
        ],
      ),
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            // shape: BoxShape.circle,
             borderRadius: BorderRadius.circular(2.0), // Optional: slightly rounded corners for the square
          ),
        ),
        // End of change
        const SizedBox(width: 8),
  ...
  decoration: BoxDecoration(
    ...
    boxShadow: [
      BoxShadow(
        ...
        color: Colors.greenAccent.withOpacity(0.6), // Adjust color and opacity as needed
        // Offset: dx=0 (no horizontal shift), dy=positive (shifts shadow down)
        offset: const Offset(0, 5), // Adjust the vertical offset (dy) for shadow distance
    ...
    child: const Text("Exercise"),
        ...
        OutlinedButton(
           style: OutlinedButton.styleFrom(
             foregroundColor: lightGreen, side: const BorderSide(color: lightGreen, width: 1.5),
             padding: const EdgeInsets.symmetric(vertical: 14),
             shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8.0)),
           ),
          onPressed: () { print("Problems button pressed"); },
