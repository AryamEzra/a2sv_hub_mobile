...
const double kCardHorizontalPadding = 24.0; // Increased horizontal padding inside card sections
const double kCardVerticalPadding = 24.0;   // Increased vertical padding inside card sections
const double kDividerVerticalSpacing = 20.0; // Increased space above/below divider
const double kCircleTextBlockSpacing = 65.0; // Increased space between circle and text
...
class StatsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Column( // Main content is now a Column directly inside the Card
  ...
  Widget _buildStatsSection({
    ...
    return Row(
      ...
      children: [
        ...
        const SizedBox(width: kCircleTextBlockSpacing), // Space remains the same
