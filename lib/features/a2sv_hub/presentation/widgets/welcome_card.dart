...
class WelcomeCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const cardBackgroundColor = Color(0xFFE0F2E9); // Adjust the green shade as needed
    ...
    return Card(
      ...
      child: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 24.0), // Inner padding
        child: Column(
